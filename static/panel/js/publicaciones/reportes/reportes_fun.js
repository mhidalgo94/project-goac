...
$(function (){
    ...
    $('#dtable').on('click', 'button[rel="delete"]' , function(){
        ...
        confirm(window.location.pathname, 'Advertencia','Estas seguro que deseas eliminar este Reporte?','warning' ,parameters, function(){
            Swal.fire({
                title : 'Notificación!',
                text : 'Reporte ha sido eliminado correctamente',
                icon: 'success',
                timer: 3000,
                onClose: () => {
                    updatetable();
    ...
    $('#dtable').on('click', 'button[rel="edit"]', function(){
        ...
        location.href = "/dashboart/publicaciones/reportes/edit_reportes/"+id_+"/";
    });
