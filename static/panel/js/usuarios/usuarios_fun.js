...
$(function (){
    ...
    $('#dtable').on('click', 'button[rel="delete"]' , function(){
        ...
        confirm(window.location.pathname, 'Advertencia','Estas seguro que deseas eliminar este usuario?','warning' ,parameters, function(){
            Swal.fire({
                title : 'Notificación!',
    ...
    $('#dtable').on('click', 'button[rel="edit"]', function(){
        ...
        location.href = "/dashboart/usuarios/edit_usuarios/"+id_+"/";
    });
