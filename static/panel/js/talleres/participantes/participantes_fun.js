...
$(function (){
    ...
    $('#dtable').on('click', 'button[rel="delete"]' , function(){
        ...
        confirm(window.location.pathname, 'Advertencia','Estas seguro que deseas eliminar este participante?','warning' ,parameters, function(){
            Swal.fire({
                title : 'Notificación!',
                text : 'Participante ha sido eliminado correctamente',
                icon: 'success',
                timer: 3000,
                onClose: () => {
                    updatetable();
    ...
    $('#dtable').on('click', 'button[rel="edit"]', function(){
        ...
        location.href = "/dashboart/talleres/participantes/edit_participantes/"+id_+"/";
    });
